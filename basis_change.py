...
#         print (Ni_i)
        if Ni_i== [0,1]:   
            ...
            slabel = [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer[0:5] + [Ni_layer[0]]+ Ni_layer[6:10]+ Cu_layer[5:15]            
        elif Ni_i==[0,3] :  
            slabel = [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer[0:10] + [Ni_layer[0]]+ Ni_layer[6:10] + Cu_layer[10:15]
        elif Ni_i==[1,2] :  
            slabel = Cu_layer[0:5]+ [Ni_layer[5]]+ Ni_layer[1:5]+  [Ni_layer[0]]+ Ni_layer[6:10]+ Cu_layer[5:15] 
        elif Ni_i==[1,3] :  
            slabel = Cu_layer[0:5]+ [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer[5:10]+ [Ni_layer[0]]+ Ni_layer[6:10]+ Cu_layer[10:15]
        elif Ni_i==[2,3] :  
            slabel = Cu_layer[0:10]+ [Ni_layer[5]]+ Ni_layer[1:5]+ [Ni_layer[0]]+ Ni_layer[6:10]+ Cu_layer[10:15]
        elif Ni_i==[0,4] :  
            slabel = [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer + [Ni_layer[0]]+ Ni_layer[6:10]
        elif Ni_i==[1,4] :  
            slabel = Cu_layer[0:5] + [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer[5:15] + [Ni_layer[0]]+ Ni_layer[6:10]     
        elif Ni_i==[2,4] :  
            slabel = Cu_layer[0:10] + [Ni_layer[5]]+ Ni_layer[1:5]+ Cu_layer[10:15] + [Ni_layer[0]]+ Ni_layer[6:10]    
        elif Ni_i==[3,4] :  
...
#         print (Cu_i)
        if Cu_i== [0,1]:   
            ...
            slabel = [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer[0:5] + [Cu_layer[0]]+ Cu_layer[6:10]+ Ni_layer[5:15]            
        elif Cu_i==[0,3] :  
            slabel = [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer[0:10] + [Cu_layer[0]]+ Cu_layer[6:10] + Ni_layer[10:15]
        elif Cu_i==[1,2] :  
            slabel = Ni_layer[0:5]+ [Cu_layer[5]]+ Cu_layer[1:5]+  [Cu_layer[0]]+ Cu_layer[6:10]+ Ni_layer[5:15] 
        elif Cu_i==[1,3] :  
            slabel = Ni_layer[0:5]+ [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer[5:10]+ [Cu_layer[0]]+ Cu_layer[6:10]+ Ni_layer[10:15]
        elif Cu_i==[2,3] :  
            slabel = Ni_layer[0:10]+ [Cu_layer[5]]+ Cu_layer[1:5]+ [Cu_layer[0]]+ Cu_layer[6:10]+ Ni_layer[10:15]
        elif Cu_i==[0,4] :  
            slabel = [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer + [Cu_layer[0]]+ Cu_layer[6:10]
        elif Cu_i==[1,4] :  
            slabel = Ni_layer[0:5] + [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer[5:15] + [Cu_layer[0]]+ Cu_layer[6:10]     
        elif Cu_i==[2,4] :  
            slabel = Ni_layer[0:10] + [Cu_layer[5]]+ Cu_layer[1:5]+ Ni_layer[10:15] + [Cu_layer[0]]+ Cu_layer[6:10]    
        elif Cu_i==[3,4] :  
